...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="px-3 py-2 small text-uppercase fw-bold">Patrimônio</div>
        ...
        <a href="index.php?c=radioPortatil"><i class="fa fa-broadcast-tower me-2"></i> Rádios Portáteis</a>
