...
{block name=content}
    <div class="row">
        ...
        <div class="col-md-{if isset($ativo)}7{else}12{/if}">
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body p-4">
                    ...
                    <form action="{if isset($ativo)}index.php?c=ativo&a=editar&t={$tipo_slug}&id={$ativo->id}{else}index.php?c=ativo&a=novo&t={$tipo_slug}{/if}" method="POST">
                        <div class="row">
                        ...
                        <div class="mb-3 bg-light p-3 border rounded">
                            ...
                            <textarea name="nova_observacao" class="form-control" rows="2" placeholder="Descreva aqui manutenções, transferências ou baixas..."></textarea>
                        </div>
                        {/if}

                        <div class="d-flex justify-content-between mt-4">
                            <a href="index.php?c=ativo&t={$tipo_slug}" class="btn btn-light"><i class="fa fa-arrow-left me-2"></i> Voltar</a>
        ...
        <!-- Coluna de Observações (Histórico) -->
        {if isset($ativo)}
        <div class="col-md-5">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-white py-3">
                ...
                <div class="card-body p-0">
                    <div class="list-group list-group-flush" style="max-height: 500px; overflow-y: auto;">
                        ...
                        {foreachelse}
                            <div class="p-4 text-center text-muted">Nenhuma observação cadastrada.</div>
                        {/foreach}
                    </div>
                </div>
            </div>
